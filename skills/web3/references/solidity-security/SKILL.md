...
description: This skill should be used when "writing smart contracts", "auditing existing contracts", "implementing security measures for blockchain applications", "preventing reentrancy attacks", "handling access control", or "preparing contracts for professional audits".
---
