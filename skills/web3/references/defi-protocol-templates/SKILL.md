...
description: This skill should be used when "building decentralized finance applications", "implementing staking platforms", "creating AMM protocols", "developing governance token systems", "building lending/borrowing protocols", or "integrating flash loan functionality".
---
