...
description: This skill should be used before "writing Solidity code", "implementing smart contracts", or "reviewing Solidity for style compliance". Must be read before writing any Solidity code. Covers ordering, naming, security patterns, and style conventions.
license: MIT
---
