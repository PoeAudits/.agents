...
**Announce at start:** Declare that the using-git-worktrees skill is being used to set up an isolated workspace.

## Directory Selection Process

1. Determine what the path for the required worktree will be "<parent-worktree-dir>/<feature-identifier>"
2. Check if already in target directory. If it is a git worktree, report and exit.
3. If in the wrong worktree, report and exit.
