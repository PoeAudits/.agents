...
description: This skill should be used when "building Next.js applications", "implementing SSR/SSG", "optimizing React Server Components", or "working with App Router". Covers Next.js 14+ App Router with Server Components, streaming, parallel routes, and advanced data fetching.
---
