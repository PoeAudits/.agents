...
description: This skill should be used when "setting up global state", "managing server state", "choosing between state management solutions", or "implementing Redux Toolkit, Zustand, Jotai, or React Query". Covers modern React state management patterns.
---
