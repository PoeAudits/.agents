...
description: This skill should be used when "refactoring legacy JavaScript code", "implementing modern ES6+ patterns", "optimizing JavaScript applications", or "writing functional programming code". Covers ES6+ features including async/await, destructuring, spread operators, arrow functions, promises, modules, iterators, generators, and functional programming patterns for writing clean, efficient JavaScript code.
---
