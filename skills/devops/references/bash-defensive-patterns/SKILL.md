...
description: This skill should be used when "writing robust shell scripts", "creating CI/CD pipelines", "building system utilities requiring fault tolerance", or "implementing production automation". Covers defensive Bash programming techniques for production-grade scripts.
---
