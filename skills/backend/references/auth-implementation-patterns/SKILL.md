...
description: This skill should be used when "implementing auth systems", "securing APIs", or "debugging security issues". Covers authentication and authorization patterns including JWT, OAuth2, session management, and RBAC to build secure, scalable access control systems.
---
