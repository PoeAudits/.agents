...
- `anthropic/claude-sonnet-4-5` - Standard workflows
...
**Purpose:** Force the command to trigger a subagent invocation  
**Type:** Boolean  
**Default:** false
...
**Use when:** Command should execute in an isolated subagent context, useful for complex workflows that benefit from a fresh context. When enabled, the command runs as a subtask and won't pollute your primary conversation context.
