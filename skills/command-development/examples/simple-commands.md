...
**Important:** All examples below are written as instructions FOR the agent (agent consumption), not messages TO users. Commands tell the agent what to do, not tell users what will happen.
...
**File:** `.opencode/commands/test-file.md`
...
**File:** `.opencode/commands/document.md`
...
**File:** `.opencode/commands/git-status.md`
...
**File:** `.opencode/commands/compare-files.md`
...
**File:** `.opencode/commands/quick-fix.md`
