...
description: This skill should be used when "optimizing prompts", "improving LLM outputs", or "designing production prompt templates". Covers advanced prompt engineering techniques to maximize LLM performance, reliability, and controllability in production.
---
...
- **`references/prompt-optimization.md`** - Prompt optimization techniques
- **`references/few-shot-learning.md`** - Few-shot learning patterns
- **`references/chain-of-thought.md`** - Chain-of-thought prompting

### Assets
- **`assets/prompt-template-library.md`** - Template library for common prompts
